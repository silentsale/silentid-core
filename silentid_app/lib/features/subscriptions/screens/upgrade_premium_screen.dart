  ...
  Future<void> _handleUpgrade() async {
    ...
    try {
      ...
      if (confirmed == true) {
        ...
        if (mounted) {
          AppMessages.showSuccess(context, 'Welcome to SilentID Premium!');
          Navigator.pop(context, true); // Return success
        }
      }
    } catch (e) {
      if (mounted) {
        AppMessages.showError(context, ErrorMessages.fromException(e, fallbackAction: 'upgrade to Premium'));
      }
    } finally {
      if (mounted) {
