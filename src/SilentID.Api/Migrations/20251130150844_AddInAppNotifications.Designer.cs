...
namespace SilentID.Api.Migrations
{
    ...
    [Migration("20251130150844_AddInAppNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SilentID.Api.Models.AdminPasskeyCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AdminPasskeyCredentials");
                });

            modelBuilder.Entity("SilentID.Api.Models.AdminSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilentID.Api.Models.AdminUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilentID.Api.Models.AuthDevice", b =>
                {
                    ...
                    b.Property<string>("IpAddressHistory")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("SilentID.Api.Models.InAppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilentID.Api.Models.LoginAttempt", b =>
                {
                    ...
                    b.Property<int>("DeviceTrustLevel")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("StepUpRequired")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("SilentID.Api.Models.ProfileConcern", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReporterDeviceInfo")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("SilentID.Api.Models.PushNotificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilentID.Api.Models.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilentID.Api.Models.User", b =>
                {
                    ...
                    b.Property<string>("ReceiptForwardingAlias")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("SilentID.Api.Models.AdminPasskeyCredential", b =>
                {
                    b.HasOne("SilentID.Api.Models.AdminUser", "AdminUser")
                        .WithMany()
