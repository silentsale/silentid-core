...
public class EvidenceController : ControllerBase
{
    ...
    // ========== v2.0: RECEIPT AND SCREENSHOT ENDPOINTS REMOVED ==========
    // The following endpoints were removed in v2.0:
    // - POST /v1/evidence/receipts/manual
    // - GET /v1/evidence/receipts
    // - POST /v1/evidence/screenshots
    // - GET /v1/evidence/screenshots/{id}
    // - GET /v1/evidence/screenshots
    // Receipts and screenshots are no longer part of the SilentID product.
    // Only profile links remain as evidence types.
...
// Request DTOs
// v2.0: AddReceiptRequest removed - receipts no longer part of product
